        ...
        {props.chats.map((chat, index) => {
          return (
            <ChatPreview
              ...
              selectedChat={
                props.selectedChat === chat.id_chat
  ...
  return (
    <>
      <div
        ...
        className={`container-chat-preview ${props.selectedChat}`}
      >
        ...
        <div className="container-dettagli-preview">
          <div className="holder-ora-nome-preview">
            ...
            <div className="ora-messaggio-preview">
              {formatLastMessageTime(props.ora_messaggio)}
            </div>
          </div>
          <div className="messaggio-preview">
            {lastMessage(props.ultimo_messaggio)}
          </div>
        </div>
      </div>
    </>
